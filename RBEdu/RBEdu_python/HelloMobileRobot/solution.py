...
class HelloMobileRobot(BaseSample):
    def __init__(self) -> None:
        ...
        self.TRACK_PATH = assets_root_path + "/Isaac/Environments/Jetracer/jetracer_track_solid.usd"
        return
    ...
    def setup_scene(self):
        ...
        track_mesh = UsdGeom.Mesh.Get(get_current_stage(), "/World/track")
        physicsUtils.set_or_add_translate_op(track_mesh, translate=Gf.Vec3f(0.0, 0.0, 0.01))
        track_geom = GeometryPrim(prim_path="/World/track", name="track", collision=True)
        track_geom.set_collision_approximation("none")
    ...
    def send_robot_actions(self, step_size):
        ...
        self._jetbot.apply_action(
            self._pose_controller.forward(
                ...
                goal_position=np.array([5.0, 0.35])
            )
        )
