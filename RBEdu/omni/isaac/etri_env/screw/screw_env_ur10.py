...
class MultiScrewEnvUR10(MultiScrewEnv):
    def __init__(
            self,
            world=None,
        ...
        if self._robot_type == "2f85":
            self.ROBOT_PATH = self._server_root + "/Projects/ETRI/Manipulator/UR10/ur10_2f85_screw_d455.usd"
        elif self._robot_type == "3f":
            self.ROBOT_PATH = self._server_root + "/Projects/ETRI/Manipulator/UR10/ur10_3f.usd"
    ...
    def setup_dataset(self):
        if self._robot_type == "2f85":
            self._robo_data_collector = RoboDataCollector(file_name=f"ur10_2f_screw_env{self._index}_" + self._now_str)
        elif self._robot_type == "3f":
            self._robo_data_collector = RoboDataCollector(file_name=f"ur10_3f_screw_env{self._index}_" + self._now_str)
