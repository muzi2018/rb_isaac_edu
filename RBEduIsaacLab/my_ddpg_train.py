...
there will be significant overhead in GPU->CPU transfer.
    ...
    or
    isaaclab -p my_ddpg_train.py --task RoadBalance-Pendulum-v0 --num_envs 16
    isaaclab -p my_ddpg_train.py --task RoadBalance-Pendulum-Direct-v0 --num_envs 16
    isaaclab -p my_ddpg_train.py --task RoadBalance-Pendulum-Direct-v0 --num_envs 16 --headless --video
    
    Viewing Log
    isaaclab -p -m tensorboard.main --logdir logs/sb3/RoadBalance-Pendulum-Direct-v0
    isaaclab -p -m tensorboard.main --logdir logs/sb3/RoadBalance-Pendulum-v0
...
@hydra_task_config(args_cli.task, "sb3_ddpg_cfg_entry_point")
